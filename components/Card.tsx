...
const Card = (props: Props) => (
  <div className="grid p-2 m-10 shadow bg-whitemode text-black max-w-xs dark:bg-gray-800 dark:text-white">
    {props.detect === "icon" ? (
      <i
        className={`devicon-${props.icon}-plain text-8xl h-auto w-auto justify-self-center`}
      ></i>
    ) : (
      <div className="shadow-lg border border-gray-200 rounded-full overflow-hidden justify-self-center">
